    ...
    <section className="">
      ...
      <div className="fixed block top-0 right-0 inline p-4">
        <div className="nav-top-sctn">
          ...
          <Link className="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded mr-2" to={"/categorylist"}>Trending </Link> 
          <Link className="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded" to={"/categorylist"}>Quicklinks  </Link>
        </div>
      </div>
      <div>
      </div>
